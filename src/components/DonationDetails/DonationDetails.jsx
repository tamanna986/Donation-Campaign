...
const DonationDetails = () => {
    const toastify = () => toast("You have successfully donated! Thank you.");
                    ...
                    weight: 390 ,
                     backgroundImage: `url(${(donation.picture)})` }}>
                        <div className="w-[400px] md:w-[670px] lg:w-[1100px] h-[30px] p-10 hero-overlay bg-opacity-60 mt-[560px] flex items-center">
                            <button onClick={toastify} className="btn btn-primary border-none " style = {buttonBg}>Donate ${donation.price}</button>
                        </div>
                    </div>
